<%-- 
  wishlist.jsp
  Displays a user's wishlist with product details and options to add items to cart or clear the wishlist.
  Includes a breadcrumb for navigation and a features section for promotional content.
