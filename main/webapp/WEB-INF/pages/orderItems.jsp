<%-- 
  orderItems.jsp
  Displays the items for a specific order, accessible to admin users.
  Includes a sidebar for navigation and a header with login/logout functionality.
  Uses JSTL for conditional rendering and looping through order items.
  Author: Soniya Sapkota
--%>
...
<head>
    ...
    <%-- Include CSS stylesheets for order items, product list, and header styling --%>
