<%-- 
  dashboard.jsp
  Displays the admin dashboard with sales statistics and a sales chart.
  Includes a sidebar for navigation and a header with login/logout functionality.
  Uses JSTL for conditional rendering and formatting, and Chart.js for sales visualization.
  Author: Sadiksha Karki
--%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%-- Import JSTL core and formatting tags --%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
<%-- Import classes for session handling --%>
...
<body>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <div class="content-body">
                ...
                <section class="stats">
                    <div class="card">Total Sales<br><strong><fmt:formatNumber value="${totalSales}" type="currency" currencySymbol="$"/></strong></div>
                    <div class="card">Total Orders<br><strong>${totalOrders}</strong></div>
                    <div class="card">Total Customers<br><strong>${totalCustomers}</strong></div>
                    <div class="card">Products in Stock<br><strong>${productsInStock}</strong></div>
                </section>
    ...
    <script>
        ...
        const weeklyData = [<c:forEach var="sale" items="${weeklySales}">${sale},</c:forEach>];
        const monthlyData = [<c:forEach var="sale" items="${monthlySales}">${sale},</c:forEach>];
        ...
        buttons.forEach((btn) => {
            btn.addEventListener('click', () => {
                ...
                salesChart.data.labels = type === 'Weekly' ? 
