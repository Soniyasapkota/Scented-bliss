<%-- 
  login.jsp
  Displays the login page for Scented Bliss, allowing users to log in or navigate to registration.
  Uses JSTL to display error or success messages and prefill the username field.
