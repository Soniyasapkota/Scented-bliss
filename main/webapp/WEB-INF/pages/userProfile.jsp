<%-- 
  userProfile.jsp
  Displays a user's profile information and allows updating personal details and password.
  Provides different layouts for admin and non-admin users, with a sidebar for admins.
  Uses JSTL for conditional rendering and session handling for role-based access.
  Author: Ishpa Maharjan and Soniya Sapkota
--%>
