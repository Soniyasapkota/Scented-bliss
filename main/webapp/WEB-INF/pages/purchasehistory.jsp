<%-- 
  purchaseHistory.jsp
  Displays a user's order history with details such as order items, status, and total price.
  Includes tabs for filtering orders and a date range filter.
  Uses JSTL for potential dynamic rendering and includes header and footer for consistent layout.
  Author: Raghav Chaulagain
--%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%-- Import JSTL core and formatting tags for conditional rendering and formatting --%>
...
<head>
    ...
    <%-- Include CSS stylesheets for purchase history, header, and footer styling --%>
