<%-- 
  contactus.jsp
  Displays the Contact Us page for Scented Bliss, including a contact form and company contact information.
  Uses header.jsp and footer.jsp for consistent navigation and footer content.
        ...
        <div class="contact-page">
            ...
            <div class="contact-box">
                ...
                <div class="form-section">
                    <%-- Form submits to Formspree for processing (replace 'yourformid' with actual ID) --%>
